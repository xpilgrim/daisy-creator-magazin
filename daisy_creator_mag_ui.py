...
class Ui_DaisyMain(object):
    def setupUi(self, DaisyMain):
        ...
        self.checkBoxCopyChangeNr1000 = QtGui.QCheckBox(self.tab_1)
        ...
        self.lineEditCopyFile1 = QtGui.QLineEdit(self.tab_1)
        ...
        self.toolButtonCopyFile2 = QtGui.QToolButton(self.tab_1)
        ...
        self.lineEditCopyFile2 = QtGui.QLineEdit(self.tab_1)
        ...
        self.checkBoxCopyChangeNr1001 = QtGui.QCheckBox(self.tab_1)
        ...
        self.checkBoxDaisyLevel = QtGui.QCheckBox(self.tab_1)
        ...
        self.checkBoxDaisyDateCalendar = QtGui.QCheckBox(self.tab_1)
        ...
        DaisyMain.setTabOrder(self.lineEditCopySource, self.toolButtonCopySource)
        DaisyMain.setTabOrder(self.toolButtonCopySource, self.lineEditCopyDest)
        DaisyMain.setTabOrder(self.lineEditCopyDest, self.toolButtonCopyDest)
        DaisyMain.setTabOrder(self.toolButtonCopyDest, self.lineEditCopyFile1)
        DaisyMain.setTabOrder(self.lineEditCopyFile1, self.toolButtonCopyFile1)
        DaisyMain.setTabOrder(self.toolButtonCopyFile1, self.lineEditCopyFile2)
        DaisyMain.setTabOrder(self.lineEditCopyFile2, self.toolButtonCopyFile2)
        DaisyMain.setTabOrder(self.toolButtonCopyFile2, self.comboBoxCopyBhz)
        DaisyMain.setTabOrder(self.comboBoxCopyBhz, self.comboBoxCopyBhzAusg)
        DaisyMain.setTabOrder(self.comboBoxCopyBhzAusg, self.checkBoxCopyBhzAusgAnsage)
        DaisyMain.setTabOrder(self.checkBoxCopyBhzAusgAnsage, self.checkBoxCopyBhzIntro)
        DaisyMain.setTabOrder(self.checkBoxCopyBhzIntro, self.checkBoxCopyBitrateChange)
        DaisyMain.setTabOrder(self.checkBoxCopyBitrateChange, self.checkBoxCopyID3Change)
        DaisyMain.setTabOrder(self.checkBoxCopyID3Change, self.checkBoxCopyChangeNr1000)
        DaisyMain.setTabOrder(self.checkBoxCopyChangeNr1000, self.checkBoxCopyChangeNr1001)
        DaisyMain.setTabOrder(self.checkBoxCopyChangeNr1001, self.checkBoxDaisyIgnoreTitleDigits)
        DaisyMain.setTabOrder(self.checkBoxDaisyIgnoreTitleDigits, self.checkBoxDaisyLevel)
        DaisyMain.setTabOrder(self.checkBoxDaisyLevel, self.checkBoxDaisyDateCalendar)
        DaisyMain.setTabOrder(self.checkBoxDaisyDateCalendar, self.comboBoxDaisyTrenner)
        DaisyMain.setTabOrder(self.comboBoxDaisyTrenner, self.comboBoxPrefBitrate)
        DaisyMain.setTabOrder(self.comboBoxPrefBitrate, self.tabWidget)
        DaisyMain.setTabOrder(self.tabWidget, self.textEdit)
        DaisyMain.setTabOrder(self.textEdit, self.commandLinkButton)
        DaisyMain.setTabOrder(self.commandLinkButton, self.pushButtonClose2)
        DaisyMain.setTabOrder(self.pushButtonClose2, self.lineEditMetaSource)
        DaisyMain.setTabOrder(self.lineEditMetaSource, self.toolButtonMetaFile)
        DaisyMain.setTabOrder(self.toolButtonMetaFile, self.lineEditMetaProducer)
        DaisyMain.setTabOrder(self.lineEditMetaProducer, self.lineEditMetaAutor)
        DaisyMain.setTabOrder(self.lineEditMetaAutor, self.lineEditMetaTitle)
        DaisyMain.setTabOrder(self.lineEditMetaTitle, self.lineEditMetaEdition)
        DaisyMain.setTabOrder(self.lineEditMetaEdition, self.lineEditMetaNarrator)
        DaisyMain.setTabOrder(self.lineEditMetaNarrator, self.lineEditMetaKeywords)
        DaisyMain.setTabOrder(self.lineEditMetaKeywords, self.lineEditMetaRefOrig)
        DaisyMain.setTabOrder(self.lineEditMetaRefOrig, self.lineEditMetaPublisher)
        DaisyMain.setTabOrder(self.lineEditMetaPublisher, self.lineEditMetaYear)
        DaisyMain.setTabOrder(self.lineEditMetaYear, self.commandLinkButtonMeta)
        DaisyMain.setTabOrder(self.commandLinkButtonMeta, self.lineEditDaisySource)
        DaisyMain.setTabOrder(self.lineEditDaisySource, self.toolButtonDaisySource)
        DaisyMain.setTabOrder(self.toolButtonDaisySource, self.textEditDaisy)
        DaisyMain.setTabOrder(self.textEditDaisy, self.commandLinkButtonDaisy)
        DaisyMain.setTabOrder(self.commandLinkButtonDaisy, self.pushButtonClose3)
        DaisyMain.setTabOrder(self.pushButtonClose3, self.textEditHelp)
        DaisyMain.setTabOrder(self.textEditHelp, self.textEditUserHelp)
        DaisyMain.setTabOrder(self.textEditUserHelp, self.pushButtonClose1)
...
"Titel aus Dateinamen verwenden und fuehrende Ziffern entfernen", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("DaisyMain", "3 Daisy", None))
